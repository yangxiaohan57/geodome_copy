...
def plot_cc(binary_image, labeled, slope, intersect):
    """
    ...
    plt.scatter(binary_image.shape[0], binary_image[1], c='red', s=100, label='Stack Base')

    # plot intersection
    plt.scatter(intersect[1], intersect[0], c='red', s=100, label='Intersect')
